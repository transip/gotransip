...
// domainWrapper object contains a Domain in it
// used to unpack the rest response and return the encapsulated Domain
// this is just used internal for unpacking, this should not be exported
// we want to return a Domain object not a domainWrapper
type domainWrapper struct {
	Domain Domain `json:"domain"`
}

// domainBrandingWrapper object contains a Branding struct in it
// used to unpack the rest response and return the encapsulated Branding
// this is just used internal for unpacking, this should not be exported
// we want to return a Branding object not a domainBrandingWrapper
type domainBrandingWrapper struct {
	Branding Branding `json:"branding"`
}

// contactsWrapper object contains a list of Contacts in it
// used to unpack the rest response and return the encapsulated Contacts
// this is just used internal for unpacking, this should not be exported
// we want to return a Branding object not a contactsWrapper
...
type Domain struct {
	...
	AuthCode string `json:"authCode,omitempty"`
	// Cancellation data, in YYYY-mm-dd h:i:s format, null if the domain is active.
	CancellationDate response.Time `json:"cancellationDate,omitempty"`
	// Cancellation status, null if the domain is active, 'cancelled' when the domain is cancelled.
	CancellationStatus string `json:"cancellationStatus,omitempty"`
	// Whether this domain is DNS only
	IsDnsOnly bool `json:"isDnsOnly,omitempty"`
	...
	Name string `json:"name"`
	// Registration date of the domain, in YYYY-mm-dd format.
	RegistrationDate response.Date `json:"registrationDate,omitempty"`
	// Next renewal date of the domain, in YYYY-mm-dd format.
	RenewalDate response.Date `json:"renewalDate,omitempty"`
}
