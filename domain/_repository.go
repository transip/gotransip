...
Transfer a domain to TransIP using its transfer key (or ‘EPP code’) by specifying it in the &#x60;authCode&#x60; parameter.  You can override the contacts, nameservers and DNS entries immediately, but is not mandatory.  ::: warning  &lt;i class&#x3D;\&quot;fa fa-warning\&quot;&gt;&lt;/i&gt; **Warning**: This API call will create an invoice!
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
